        ...
        <Container className="mt-10 md:mt-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-5">
            ...
            <div className=" p-2 sm:p-4 md:p-8 max-w-screen-sm mx-0 md:mx-10 lg:mx-20 mt-5 md:mt-0 space-y-3">
              ...
              {selectedStock === 0 ? (
                <>
                  <p className="font-semibold">Follow Our Social Media for latest Updates</p>
                  <div className="flex space-x-4 ">
                    <Link href="https://www.facebook.com/artiartuae" target="_blank" className="w-9 h-9 rounded-full bg-white shadow  flex justify-center items-center hover:shadow-md">
                      <FaFacebookF size={18} className='text-blue-600' />
                    </Link>
                    <Link href="https://www.instagram.com/artiartuae/" target="_blank" className="w-9 h-9 rounded-full bg-white  flex justify-center items-center shadow hover:shadow-md">
                ...
                <>
                  ...
                  <Button className="border w-full rounded-none border-black hover:bg-slate-100" onClick={handleAddToCart} title={"Add to Cart"} />
                  <Link
                    href={{
                      pathname: '/checkout',
                      query: { subtotal: (parsedProduct.discountPrice ? parsedProduct.discountPrice : parsedProduct.price).toString() },
                    }}
                  >

                    <Button className={"bg-black w-full mt-2 rounded-none text-white hover:bg-slate-900"} title={"Buy It Now"} />
                  </Link>
                </>
              )}

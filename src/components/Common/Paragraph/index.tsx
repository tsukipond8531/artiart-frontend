...
export const Para16: React.FC<ParaProps> = ({
  title,
  icon,
  className,
  endicon,
...
export const Para14: React.FC<ParaProps> = ({
  title,
  icon,
  className,
  endicon,
...
export const Para12: React.FC<ParaProps> = ({
  title,
  icon,
  className,
  endicon,
...
export const Para18: React.FC<ParaProps> = ({
  title,
  icon,
  className,
  endicon,

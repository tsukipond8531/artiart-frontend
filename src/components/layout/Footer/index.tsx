        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="py-12 grid grid-cols-12 gap-x-5 gap-y-8">
            ...
            <div className="block  xl:text-left  col-span-full min-[500px]:col-span-6 md:col-span-4 xl:col-span-3 xl:pl-5">
              <h4 className="text-lg text-gray-900 font-bold lg:mb-9 mb-5">
                Get In Touch
              </h4>
              <ul className="text-gray-900 transition-all duration-500 grid gap-4 text-14 pr-8">
                ...
                <li className="cursor-pointer flex gap-3 items-center">
                  ...
                  <Link href={'tel:+97145899888'}>+971 4 589 9888</Link>
                </li>
                <li className="cursor-pointer flex gap-3 items-top">
                  <span className="text-[20px]">
                    <IoLocationOutline />{' '}
                  </span>
                  <Link href={'https://maps.app.goo.gl/2gsB3J2XnnBGQ1ao9'}>
                    Shop 5, Khalil Al Sayegh Building, Oud Metha, Umm Hurair
                    Road - 2nd St - Dubai
                  </Link>
                </li>
              </ul>
            ...
            <div className="block  col-span-6 min-[500px]:col-span-6 md:col-span-4 xl:col-span-2">
              <h4 className="text-lg text-gray-900 font-bold lg:mb-9 mb-5 xl:text-left">
                Quick Links
              </h4>
            ...
            <div className="block  col-span-full md:col-span-4 xl:col-span-2">
              <h4 className="text-lg text-gray-900 font-bold lg:mb-9 mb-5 text-center xl:text-left">
              ...
              <div className="border border-slate-700 flex rounded-full w-fit pl-4 gap-2 ">
                <input
                  type="text"
                  name="email"
                  className="bg-transparent focus:outline-none  text-gray-800 text-lg w-full"
                  placeholder="Enter email.."
                />
                <button
                  type="submit"
                  className="bg-black duration-500 flex h-10 items-center justify-center mx-auto px-4 py-0 rounded-full shadow-md text-12 text-white transition-all w-fit xl:mx-0"
                >
                  <svg
                    width={17}
                    height={13}
        ...
        <div className="py-2 bg-indigo-50 ">
          <div className="flex flex-wrap md:flex-nowrap items-center lg:text-lef text-center justify-between  max-w-screen-xl mx-auto">
            <div className="space-x-4 px-1 text-12">
              ...
              <Link className="underline" href={'/terms-condition'}>
                Terms & Condition
              </Link>
              <Link className="underline" href={'/return-refund'}>
                Return and Refund
              </Link>
            ...
            <span className="text-12 text-gray-800 lg:text-center mt-2 lg:mr-auto m-auto">
              Copyright@2024 All Right Reserved by <Link href="/">Artiart</Link>
            </span>
          </div>
        </div>
      </footer>

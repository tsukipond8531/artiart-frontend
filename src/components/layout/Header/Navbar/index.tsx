...
const Navbar: React.FC = () => {
  ...
  return (
    <>
    <div className=" px-2 py-2 flex flex-wrap justify-between max-w-screen-xl mx-auto items-center">
      <Link className="hover:underline text-12 md:text-14 font-semibold" href={"mailto:cs@artiart.ae"}>cs@artiart.ae</Link>
      <Link className="hover:underline text-12 md:text-14 font-semibold" href={"tel:+971 58 820 0549"}>+971 58 820 0549</Link>
      
      <div className="flex  space-x-2 md:space-x-4 sm:justify-center  ">
          ...
          <Link href="/" className="w-7   h-7   rounded-full flex justify-center items-center shadow-md hover:shadow">

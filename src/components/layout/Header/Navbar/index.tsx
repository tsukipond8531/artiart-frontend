    ...
    <>
      ...
      <nav className={` text-black border-t  sticky top-0  z-20 shadow-md  ${scrollingUp ? defaultStyle : scrolledStyle}`}>
        ...
        <div className=" flex py-4 pt-2 pb-2 lg:gap-20">
          ...
          <Link href="https://www.facebook.com/artiartuae" target="_blank"  className="w-7   h-7   rounded-full  flex justify-center items-center shadow-md hover:shadow">
          <FaFacebookF  className='text-blue-600' />
          </Link>
          <Link href="https://www.instagram.com/artiartuae/" target="_blank"  className="w-7   h-7   rounded-full  flex justify-center items-center shadow-md hover:shadow">
      ...
      <Link href={"https://api.whatsapp.com/send/?phone=971588200549&text&type=phone_number&app_absent=0"} target="_blank"  className=" fixed lg:bottom-10 bottom-20 right-10 z-50">

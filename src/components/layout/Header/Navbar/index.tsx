          ...
          <div className=" flex py-4 pt-2 pb-2 lg:gap-20">
            ...
            <div className="flex gap-2 ml-auto items-center justify-center">
              <div className="flex items-center  gap-3 md:gap-5">
                <Button
                  className="bg-transparent text-black group"
                  onClick={() => {
                    setOpen(true);
                  }}
                  title={<IoSearchSharp className="text-black" size={25} />}
                />
                <Modal
                  open={open}
                  onOk={() => setOpen(false)}
                ...
                <div className="flex pl-5  space-x-2 md:space-x-4 sm:justify-center  ">
                  <Link
                    ...
                    target="_blank"
                    className="w-7   h-7   rounded-full  flex justify-center items-center shadow-md hover:shadow"
                  >
                  ...
                  DrawerContent={
                    <>
                      <div className="flex flex-col space-y-2">
                        ...
                        <Drawerfilter
                          className="poppins-thin text-16  "
                          title="Shop"

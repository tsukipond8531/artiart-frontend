    ...
    <Navbar/>
        ...
        <div className='max-w-screen-md mx-auto space-y-5 '>
            ...
            <ul className='px-1 md:px-5 space-y-3'>
                <li className='list-decimal'>We present this Privacy Policy to clarify how we handle your information when you use our Services. </li>
                <li className='list-decimal'>ArtiArt collects personal information including: your name, email address, telephone number, physical address.</li>
                <li className='list-decimal'>Additional information could be: age, gender, hobbies, interests, and other related information.</li>
                <li className='list-decimal'>ArtiArt does not collect or store credit card numbers or bank details. We use a trusted payment portal to process card  payments and details are kept securely with that third party.</li>
                <li className='list-decimal'>We may collect usage data such as IP addresses, browser types, operating systems, device information, and cookies. These data points help to improve our services and provide you with a superior user experience.</li>
                  <li className='list-decimal'>We are committed to preserving your privacy and ensuring your satisfaction with our services. </li>
            </ul>

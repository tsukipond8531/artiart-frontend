        ...
        <div className="flex flex-wrap md:flex-nowrap gap-0 md:gap-5 p-2">
          <div className="w-full md:w-1/2  ">
            ...
            <table className="text-start mt-3">
              <tbody>
                <tr>
                  <th className="text-start pt-3 poppins-semibold w-1/6 lg:text-16 text-14">
                    Call Support:
                  </th>
                ...
                <tr className="mt-5">
                  <th className="text-start pt-3 poppins-semibold w-1/6">
                    WhatsApp :
                  </th>
                ...
                <tr>
                  <th className="text-start pt-3 poppins-semibold w-1/6 lg:text-16 text-14 flex align-top">
                    Email:
                  </th>
                  <td className="font-bold pt-3 poppins-thin text-start lg:text-16 text-14">
                    <Link href="mailto:cs@artiart.ae">cs@artiart.ae</Link>
                  </td>
                </tr>
                <tr>
                  <th className="text-start pt-3 poppins-semibold w-1/6">
            ...
            <div className="mt-7">
              <iframe
                className="w-full"
                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14435.668236099693!2d55.3078729!3d25.2397184!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f43f93ce538b3%3A0xcdfd02fa5f29d2ce!2sArti%20Art%20UAE%20-%20Suction%20Mugs%20Distributor!5e0!3m2!1sen!2sae!4v1715750104768!5m2!1sen!2sae"
                width="600"
                height="195"
              ></iframe>
            </div>

    ...
    <>
      ...
      <Container className="mt-10 md:mt-20">
        <div className="max-w-screen-md mx-auto space-y-5 ">
          <HeadingH3
            className=""
            title={'Terms & Conditions–Elite Concepts General Trading LLC'}
          />
          <Para14
            title={
          ...
          <p>
            The Elite Concepts General Trading LLC Terms and Conditions
            (&apos;Terms&apos;) considered as a legal agreement between you and
            (&apos;User,&apos; &apos;you,&apos; or &apos;your&apos;) and Elite
            Concepts General Trading LLC, Inc. (&apos;Elite Concepts General
            Trading LLC,&apos; &apos;Company,&apos; &apos;we,&apos;
            &apos;our,&apos; or &apos;us&apos;). These Terms and Conditions,
            incorporated and presented after careful consideration, govern and
            secure your use of our website located at www.artiart.ae
            (&apos;website&apos;), including all content that is posted,
            functionality, and services offered on or through the website by
            Elite Concepts General Trading LLC.
          </p>
          <p>
          ...
          <p>
            ...
            Elite Concepts General Trading LLC, you are bound to accept these
            terms and conditions. Also, it will be considered as a proof that
            you agree to the terms, conditions and notices contained on the
            website or referenced herein. If you do not agree to these terms,
            you must not access or use the website and its content or services
            provided by Elite Concepts General Trading LLC.
          </p>
          <p>
          ...
          <p>
            ...
            refer to Elite Concepts General Trading LLC’s Delivery Policy,
            Refund & Return Policy, Shipping Policy before making any purchase
            from our website (www.artiart.ae). Please be advised that by
            agreeing to these general T&Cs, you are accepting the other T&Cs
            outlined in the Delivery Policy, Refund & Return Policy and Shipping
            Policy. These policies are all part of a legally binding contract
            between Elite Concepts General Trading LLC and “you” (user of this
            website and services).
          </p>
          <p>
            By agreeing to these terms, you represent and warrant that you are
            of legal age to use the website and the services provided by Elite
            Concepts General Trading LLC, under the law of the United Arab
            Emirates to form a binding contract with Elite Concepts General
            Trading LLC.
          </p>
          <HeadingH6
            className="font-semibold"
          ...
          <p>
            ...
            Conditions of our website (www.artiart.ae) will take effect
            immediately once they are updated. These changes and updates will
            ...
            to the changes and updated T&Cs, Delivery Policy, Refund and Return
            Policy, and Shipping Policy.
          </p>
          <p>
            We strongly recommend you to regularly review and have a clear
            understanding of these Terms and Conditions that govern your use of
            the website and its services. Whenever these terms are updated, we
          ...
          <p>
            ...
            following in order to access and engage with Elite Concepts General
            Trading LLC’s website and its services in future.
          </p>
          ...
          <p>
            Subject to these Terms, Elite Concepts General Trading LLC grants
            you a non-transferable, non-exclusive, revocable, limited license to
            access and use the website exclusively for your personal,
            non-commercial use.
          </p>
          <p>
